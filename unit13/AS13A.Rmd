...
&emsp; &emsp;answer:11.192%<br>
&emsp; &emsp; ■ 兩個自變數的勝率效果分別是？<br>
&emsp; &emsp;answer:OfficeVisits：1.0856倍,Narcotics：1.0793倍<br>
&emsp; &emsp; ■ 兩個自變數的機率效果分別是？<br>
&emsp; &emsp;answer:OfficeVisits：1.0753倍,Narcotics：1.0697倍<br>
```{r}
...
&emsp; &emsp; ■ `PoorCare = 1`的機率是？<br>
&emsp; &emsp;answer:28.947%<br>
&emsp; &emsp; ■ 兩個自變數的勝率效果分別是？<br>
&emsp; &emsp;answer:OfficeVisits：1.0856倍,Narcotics：1.0793倍<br>
&emsp; &emsp; ■ 兩個自變數的機率效果分別是？<br>
&emsp; &emsp;answer:OfficeVisits：1.0593倍,Narcotics：1.055倍<br>
```{r}
...
&emsp;&emsp;answer:隨著變數變大，機率效果變小，勝率效果因為是看係數，所以不會隨著變數改變
