...
A:可以觀察與藍色線（p=0.5）的相對位置，在上面我們可以說他被預測為ｙ＝１的機率會大於0.5
在下面我們可以說他被預測為ｙ＝１的機率會小於0.5
<br><hr>
...
Ａ：logit是odd取log後的結果，也是線性function計算後的結果。
logistic function：將logit的結果，投射到1/1+exp(-logit)的機率分佈。
